...
/// Secure screen protection for fintech apps.
///
/// Use cases:
/// - Banking apps
/// - Wallet apps
...
class FlutterSecureScreen {
  static const MethodChannel _channel =
      MethodChannel('flutter_secure_screen');
  ...
  static Future<void> enableScreenshotBlocking() async {
    try {
      ...
      throw SecureScreenException(e.message ?? e.toString());
    }
  }
...
/// Exception thrown when secure screen operations fail.
