...
/**
 * FlutterScreenshotGuardPlugin - Screenshot and screen recording guard for fintech apps.
 *
 * Features:
 * - Disable screenshots and screen recording (FLAG_SECURE)
 * - Blur/obscure app when in background (shown in app switcher)
 */
class FlutterScreenshotGuardPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_screenshot_guard")
