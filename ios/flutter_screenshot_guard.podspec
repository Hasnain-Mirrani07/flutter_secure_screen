...
# Run `pod lib lint flutter_screenshot_guard.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_screenshot_guard'
  s.version          = '1.0.0'
  s.summary          = 'Screenshot and screen recording guard for fintech apps'
  s.description      = <<-DESC
