...
void main() {
  ...
  group('FlutterScreenshotGuard', () {
    ...
    test('setBlurIntensity sends intensity argument', () async {
      ...
      await FlutterScreenshotGuard.setBlurIntensity(0.8);
    ...
    test('setBlurIntensity clamps to 0.0-1.0', () async {
      ...
      await FlutterScreenshotGuard.setBlurIntensity(2.0);
    ...
    test('throws ScreenshotGuardException on platform error', () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (MethodCall call) async {
      ...
      expect(
        () => FlutterScreenshotGuard.enableScreenshotBlocking(),
        throwsA(isA<ScreenshotGuardException>().having(
          (e) => e.message,
          'message',
  ...
  group('ScreenshotGuardException', () {
    test('toString returns message', () {
      const message = 'test error';
      expect(
        ScreenshotGuardException(message).toString(),
        'ScreenshotGuardException: $message',
      );
    });
  });
}
