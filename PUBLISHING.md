...
3. **Optional: change Android package name** (recommended for production):
   - In `pubspec.yaml` under `flutter.plugin.platforms.android.package`, change from `com.example.flutter_secure_screen` to e.g. `com.yourcompany.flutter_secure_screen`.
...
5. **After publishing**:
   - Add the package URL to the README badge: `https://img.shields.io/pub/v/flutter_secure_screen.svg`
